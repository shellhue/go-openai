# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/code.byted.org/newcony/go-openai.svg)](https://pkg.go.dev/code.byted.org/newcony/go-openai)
[![Go Report Card](https://goreportcard.com/badge/code.byted.org/newcony/go-openai)](https://goreportcard.com/report/code.byted.org/newcony/go-openai)
[![codecov](https://codecov.io/gh/shellhue/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/shellhue/go-openai)
...
```
go get code.byted.org/newcony/go-openai
```
...
import (
	"context"
	"fmt"
	openai "code.byted.org/newcony/go-openai"
)
...
See also: https://pkg.go.dev/code.byted.org/newcony/go-openai#ClientConfig
</details>
...
import (
	...
	"code.byted.org/newcony/go-openai"
	"code.byted.org/newcony/go-openai/jsonschema"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://code.byted.org/newcony/go-openai/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://code.byted.org/newcony/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://code.byted.org/newcony/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://code.byted.org/newcony/go-openai/graphs/contributors) and sponsors of this project:
